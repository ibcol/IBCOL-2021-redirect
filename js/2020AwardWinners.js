...
var pjName = [
    ...
    ['National blockchain driven private cloud-based platform for Bangladesh: adopted in land administration', 'Decentralized Identity and Aid Distribution Platform for Rohingya Refugees'],
    ['MediTech Bangla', 'PROBAHO - Decentralized VAT Automation Network for Ensuring Economic Growth'],
    ['RETransparentNET, A Platform for Secure Transaction in Real Estate Industry', 'Arun'],
    ['ReliChain : Trust and transparency in relief supply chain', 'Blockchain to Prevent Public Health Risks caused by Counterfeit Skin and Health Care Products'],
    ['BONTON, A Transparent Relief Distribution Using Blockchain Technology', 'AprChain'],
    ['CampusSafe, Helping Students to Get Back to Schools Safely', 'justbOT'],
    ['Carbonbase', 'Golden Pear'],

    ['Blockchain in Crane Risk management', 'Spearchain: transparent track-and-trace platform for monitoring medical donation'],
    ['One-stop rental & asset management program', 'Privacy-preserving certification of the antibody test'],
    ['Ukwazi', 'Blockchain for microcredit'],
    ['Khany' + "'" + 'iSA: Illuminate South Africa', 'Blockchain-based Organizational Whistleblowing System (BOWS)'],
    ['SmartLending', 'Blockchain Technology for Aviation Inventory Management'],
    ['BCred: A Blockchain Platform for Academic Credentials', 'Optimise Payment Practice in Hong Kong Construction Industry by Blockchain Technology'],

    ['Credible news platform', 'Blockchain IoT for Supply Chain'],
    ['Subay', 'E-stamp'],
    ['Remote voting system for universities based on blockchain', 'Researchain | Decentralize Knowledge'],
    ['Founder-friendly avenue of raising capital', 'Blockchain and AI application for health microinsurance']
];

var img = [
    ['.././images/2020-IBCOL-Finalists/flat/bdFlag.png', '.././images/2020-IBCOL-Finalists/flat/bdFlag.png'],
    ['.././images/2020-IBCOL-Finalists/flat/bdFlag.png', '.././images/2020-IBCOL-Finalists/flat/bdFlag.png'],
    ['.././images/2020-IBCOL-Finalists/flat/bdFlag.png', '.././images/2020-IBCOL-Finalists/flat/bdFlag.png'],
    ['.././images/2020-IBCOL-Finalists/flat/bdFlag.png', '.././images/2020-IBCOL-Finalists/flat/bdFlag.png'],
    ['.././images/2020-IBCOL-Finalists/flat/bdFlag.png', '.././images/2020-IBCOL-Finalists/flat/bdFlag.png'],
    ...
    ['.././images/2020-IBCOL-Finalists/flat/caFlag.png', '.././images/2020-IBCOL-Finalists/flat/caFlag.png'],

    ['.././images/2020-IBCOL-Finalists/flat/cnFlag.png', '.././images/2020-IBCOL-Finalists/flat/cnFlag.png'],

    ['.././images/2020-IBCOL-Finalists/flat/hkFlag.png', '.././images/2020-IBCOL-Finalists/flat/hkFlag.png'],
    ['.././images/2020-IBCOL-Finalists/flat/hkFlag.png', '.././images/2020-IBCOL-Finalists/flat/hkFlag.png'],
    ['.././images/2020-IBCOL-Finalists/flat/hkFlag.png', '.././images/2020-IBCOL-Finalists/flat/hkFlag.png'],
    ['.././images/2020-IBCOL-Finalists/flat/hkFlag.png', '.././images/2020-IBCOL-Finalists/flat/hkFlag.png'],
    ['.././images/2020-IBCOL-Finalists/flat/hkFlag.png', '.././images/2020-IBCOL-Finalists/flat/hkFlag.png'],
    ...
    ['.././images/2020-IBCOL-Finalists/flat/nlFlag.png', '.././images/2020-IBCOL-Finalists/flat/nlFlag.png'],

    ['.././images/2020-IBCOL-Finalists/flat/phFlag.png', '.././images/2020-IBCOL-Finalists/flat/plFlag.png'],

    ['.././images/2020-IBCOL-Finalists/flat/plFlag.png', '.././images/2020-IBCOL-Finalists/flat/twFlag.png'],
    ['.././images/2020-IBCOL-Finalists/flat/usFlag.png', '.././images/2020-IBCOL-Finalists/flat/vnFlag.png']
];
...
for (let i = 0; i < 18; i++) {
    ...
    for (let j = 0; j <= 1; j++) {
        ...
        if (j == 1) {
            ...
            awardRowX.innerHTML += (
                '<div class="col-md-6 col-sm-12 centre mt-5 mt-md-0 pointer"  onclick="meritWinners(' + "'" + targetCountry + indexArr[i][j] + "'" + ')">' +
                '<div class="">' +
                '<div class="" id="winnerInfo">' +
                '<div class="row w-100 mx-0">' +
                '<div class="col-auto col-sm-4 text-right-413-centre">' +
                '<img class="" src="' + img[i][j] + '">' +
                '</div>' +
            ...
            awardRowX.innerHTML += (
                '<div class="col-md-6 col-sm-12 centre pointer" onclick="meritWinners(' + "'" + targetCountry + indexArr[i][j] + "'" + ')">' +
                '<div class="">' +
                '<div class="" id="winnerInfo">' +
                '<div class="row w-100 mx-0">' +
                '<div class="col-auto col-sm-4 text-right-413-centre">' +
...
function meritWinners(target) {
    ...
    var hk = [
        ...
        './2020-IBCOL-Finalists/HK-12-representatives/Khany'+"'"+'iSA/index.html',
